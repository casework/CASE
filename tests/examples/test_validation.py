...
def test_investigative_action_PASS_validation():
    """
...
def test_investigative_action_XFAIL_validation_XPASS_wrong_property_placement():
    """
...
def test_investigative_action_XFAIL_validation():
    """
